...
func TestReElection2A(t *testing.T) {
	...
	fmt.Printf("begin check, ________________ \n")
	cfg.Output()
	leader1 := cfg.checkOneLeader()

	// if the leader disconnects, a new one should be elected.
	cfg.disconnect(leader1)
	fmt.Printf("if the leader disconnects, ________________ \n")
	cfg.Output()

	cfg.checkOneLeader()
	// if the old leader rejoins, that shouldn't
	// disturb the new leader.
	fmt.Printf("if the old leader rejoins, ________________\n")
	cfg.Output()
	...
	time.Sleep(2 * RaftElectionTimeout)
	fmt.Printf("if there's no quorum, ________________\n")
	cfg.Output()
	...
	fmt.Printf("after a quorum happen, ________________\n")
	cfg.Output()
	...
	cfg.connect(leader2)
	fmt.Printf("connect leader2 , ________________\n")
	cfg.Output()
